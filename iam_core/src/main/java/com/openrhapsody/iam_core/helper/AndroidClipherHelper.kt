 ...
 * @since 25 - May - 2018
 */
object AndroidCipherHelper {
    private const val TAG = "AndroidRsaCipherHelper"
    ...
    internal fun init(applicationContext: Context) {
        ...
        result = if (keyStore.containsAlias(alias)) {
            ...
            Log.v(TAG, "No keypair for ${alias}, creating a new one")
    ...
    private fun initAndroidM(alias: String): Boolean {
        try {
            ...
            Log.i(TAG, "Random keypair with ${KeyProperties.KEY_ALGORITHM_RSA}/${KeyProperties.BLOCK_MODE_CBC}/${KeyProperties.ENCRYPTION_PADDING_RSA_PKCS1} is created.",)
    ...
    private fun initAndroidL(alias: String): Boolean {
        try {
            ...
            Log.i(TAG, "Random RSA algorithm keypair is created.")
